...
// packages/server/src/next-route-handlers.ts
function createPalmprintRoutes(options) {
  const sdk = options.palmprint ?? createPalmprintServer({
  ...
  async function challenge(req) {
    ...
    const result = sdk.issueChallenge({
      requiredLevel: typeof body.required_level === "string" ? body.required_level : void 0,
      requiredSteps: typeof body.required_steps === "number" ? body.required_steps : void 0,
      ttlSeconds: typeof body.ttl_seconds === "number" ? body.ttl_seconds : void 0,
      subject: typeof body.subject === "string" ? body.subject : void 0,
      audience: typeof body.audience === "string" ? body.audience : void 0,
  ...
  async function redeem(req) {
    ...
    const result = await sdk.issueSession({
      challengeToken,
      clientToken,
      ttlSeconds: typeof body.session_ttl_seconds === "number" ? body.session_ttl_seconds : void 0,
      subject: typeof body.subject === "string" ? body.subject : void 0
    });
    return Response.json({
...
export {
  createPalmprintRoutes
};
//# sourceMappingURL=next-route-handlers.js.map
